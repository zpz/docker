...
#
# on 6/8/2017 with IPython version 6.1.0.
...
#c.InteractiveShell.banner1 = "Python 3.5.3 (default, May 11 2017, 22:09:56) \nType 'copyright', 'credits' or 'license' for more information\nIPython 6.1.0 -- An enhanced Interactive Python. Type '?' for help.\n"
...
#         highlighting: 
#  emacs, lovelace, colorful, bw, rrt, xcode, arduino, default, pastie, murphy, native, friendly, manni, trac, vs, paraiso-dark, vim, algol, paraiso-light, igor, abap, borland, perldoc, algol_nu, monokai, autumn, tango, fruity, rainbow_dash
