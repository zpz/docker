...
Copy this file to /etc/xdg/ptpython/config.py
"""
...
def configure(repl):
    ...
    #
    # Do not enable this.
    # Enabling this will disable copying the content of the screen
    # and scrolling the screen.
    #
    ...
    #
    # I did not see the effect of this setting.
